...
use \Exception;
use \PDO;
use Dende\SoccerBot\Model\GroupChat as ChildGroupChat;
...
/**
 * Base class that represents a query for the 'groupchats' table.
 *
 *
 *
 ...
 * @method     ChildGroupChatQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildGroupChatQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildGroupChatQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildGroupChatQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildGroupChat findOne(ConnectionInterface $con = null) Return the first ChildGroupChat matching the query
 * @method     ChildGroupChat findOneOrCreate(ConnectionInterface $con = null) Return the first ChildGroupChat matching the query, or a new ChildGroupChat object populated from the query conditions when no match is found
 *
 ...
 *
 */
abstract class GroupChatQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Dende\SoccerBot\Model\Base\GroupChatQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Dende\\SoccerBot\\Model\\GroupChat', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildGroupChatQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildGroupChatQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildGroupChatQuery) {
            return $criteria;
        }
        $query = new ChildGroupChatQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildGroupChat|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = GroupChatTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildGroupChat A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildGroupChat $obj */
            $obj = new ChildGroupChat();
            $obj->hydrate($row);
            GroupChatTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(GroupChatTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(GroupChatTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(GroupChatTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(GroupChatTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupChatTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByChatId($chatId = null, $comparison = null)
    {
        if (is_array($chatId)) {
            $useMinMax = false;
            if (isset($chatId['min'])) {
                $this->addUsingAlias(GroupChatTableMap::COL_CHAT_ID, $chatId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($chatId['max'])) {
                $this->addUsingAlias(GroupChatTableMap::COL_CHAT_ID, $chatId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupChatTableMap::COL_CHAT_ID, $chatId, $comparison);
    }
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupChatTableMap::COL_TYPE, $type, $comparison);
    }
     ...
     *
     * @param   ChildGroupChat $groupChat Object to remove from the list of results
     *
     * @return $this|ChildGroupChatQuery The current query, for fluid interface
     */
    public function prune($groupChat = null)
    {
        if ($groupChat) {
            $this->addUsingAlias(GroupChatTableMap::COL_ID, $groupChat->getId(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            GroupChatTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(GroupChatTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            GroupChatTableMap::removeInstanceFromPool($criteria);
