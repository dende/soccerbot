...
class TeamTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Dende.SoccerBot.Model.Map.TeamTableMap';
     ...
     */
    const OM_CLASS = '\\Dende\\SoccerBot\\Model\\Team';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Dende.SoccerBot.Model.Team';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Code', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'code', ),
        self::TYPE_COLNAME       => array(TeamTableMap::COL_ID, TeamTableMap::COL_NAME, TeamTableMap::COL_CODE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'code', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Code' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'code' => 2, ),
        self::TYPE_COLNAME       => array(TeamTableMap::COL_ID => 0, TeamTableMap::COL_NAME => 1, TeamTableMap::COL_CODE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'code' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Dende\\SoccerBot\\Model\\Team');
    ...
    {
        $this->addRelation('MatchRelatedByHomeTeamId', '\\Dende\\SoccerBot\\Model\\Match', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':home_team_id',
    1 => ':id',
  ),
), null, null, 'MatchesRelatedByHomeTeamId', false);
        $this->addRelation('MatchRelatedByAwayTeamId', '\\Dende\\SoccerBot\\Model\\Match', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':away_team_id',
    1 => ':id',
  ),
), null, null, 'MatchesRelatedByAwayTeamId', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TeamTableMap::COL_CODE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Dende\SoccerBot\Model\Team) { // it's a model object
